...
passengersdisembark_bp = Blueprint("passengersdisembark", __name__)

@passengersdisembark_bp.route("/passengers_disembark", methods=["GET", "POST"])
def passengers_disembark():
    ...
    return render_template("passengers_disembark.html", error=error_msg, form=form_data)
