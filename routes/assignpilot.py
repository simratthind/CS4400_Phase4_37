...
assignpilot_bp = Blueprint("assignpilot", __name__)

@assignpilot_bp.route("/assign_pilot", methods=["GET", "POST"])
def assign_pilot():
    error_msg = None
    data = {
        "airline_id": "",
    ...
    return render_template("assign_pilot.html", error=error_msg, form=form_data)
